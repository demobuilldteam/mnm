...
<![endif]-->
    <?php 
        ...
        if(isset($_POST['submit'])){
            ...
            $qrcheck = "select maloai from loai where maloai='{$matheloai}'";
            $rscheck = mysqli_query($conn,$qrcheck);
            if(mysqli_num_rows($rscheck)==0){
                $qr = "insert into loai values('$matheloai','$tentheloai')";
                ...
                $_SESSION['noti-err-ml'] = "Matheloai is available!!";
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Thêm thể loại</h3>
                        <ol class="breadcrumb">
                            ...
                            <div class="card-block">
                                ...
                                <form class="form-horizontal form-material" method="POST" action="add-theloai.php" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="matheloai"  class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Tên thể loại</label>
                                        <div class="col-md-12">
                                            <input type="text" name="tentheloai"  class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
