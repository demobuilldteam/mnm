                            ...
                            <div class="card-block">
                                <form class="form-horizontal form-material" method="POST" action="add-user.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="fullname" palceholder="John" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="address" placeholder="Da Nang" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Công ty</label>
                                        <div class="col-md-12">
                                            <input type="text" name="company" placeholder="Dai Phat" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="rule"  placeholder="user" class="form-control form-control-line" >
                                        </div>
                                    </div>
